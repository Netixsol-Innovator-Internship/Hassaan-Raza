        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-base font-montserrat text-gray-600">
              <div className="flex gap-1 "> <img className="h-4 w-4" src="./Location.png" alt ="" /> <span> 1 Hacker Way, Menlo Park, CA 94301, USA </span></div>
              <div className="flex gap-1 "><img  className="h-4 w-4"src="Email.png" alt="" />  <span> Email: smoopsy@gmail.com </span></div>
              <div className="flex gap-1 "><img  className="h-4 w-4"src="Phone.png" alt="" />  <span> Tel: +92 9770369406 </span></div>
            </div>
          </div>
        </div>
      </div>
