        ...
        <CardContent className="p-0">
          ...
          <div className="p-4 space-y-2">
            <div className="flex  flex-col text-center justify-center items-center">
              <h3 className="font-montserrat font-medium text-[#4e4d4d] line-clamp-2">{product.name}</h3>
              <div className="text-right">
                <div className="font-montserrat font-semibold text-[#4e4d4d]">€{product.price} / 50 g</div>
              </div>
            </div>
